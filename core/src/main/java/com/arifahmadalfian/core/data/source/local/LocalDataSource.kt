package com.arifahmadalfian.core.data.source.local

import com.arifahmadalfian.core.data.source.local.entity.TourismEntity
import com.arifahmadalfian.core.data.source.local.room.TourismDao
